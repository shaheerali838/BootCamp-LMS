...
const AuthLayout = () => {
  ...
  <div className="hidden lg:flex w-full h-screen bg-white text-blue-900 px-8 xl:px-10 py-6 flex-col justify-between overflow-hidden border-r border-gray-200">
    ...
    <div className="px-4">
      ...
      <p className="text-blue-700 text-sm leading-6 py-3 max-w-2xl">
        SMIT is Pakistan's largest non-profit IT learning
        initiative — web development, AI, networking, and
        design, taught by industry experts, with no tuition
        fees, ever.
      </p>

    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-5">
        <div className="bg-white border border-gray-200 rounded-xl px-4 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">{totalBatches}</h2>
            <p className="text-xs text-gray-500 uppercase tracking-wide mt-1">Total Batches</p>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl px-4 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">{activeBatches}</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl px-4 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">{completedBatches}</h2>
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden relative min-h-[200px]">
        {loading && (
        ...
        <div className="overflow-x-auto">
          <div className="grid grid-cols-[1.8fr_1fr_1.5fr_1.2fr_1fr_1fr] min-w-[860px] items-center px-4 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase">
          ...
          <div className="divide-y divide-gray-100 min-w-[860px]">
            {filteredBatches.map((item) => (
              <div
                key={item._id}
                className="grid grid-cols-[1.8fr_1fr_1.5fr_1.2fr_1fr_1fr] items-center px-4 py-3 hover:bg-gray-50 transition"
              >
                <span className="text-sm font-medium text-gray-900">{item.batchName}</span>
